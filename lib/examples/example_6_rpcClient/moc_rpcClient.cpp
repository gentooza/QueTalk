...
struct qt_meta_stringdata_rpcClient_t {
    QByteArrayData data[6];
    char stringdata[79];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_rpcClient_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_rpcClient_t qt_meta_stringdata_rpcClient = {
    {
...
QT_MOC_LITERAL(5, 69, 8)
    ...
    "rpcClient\0slotInvokeRemoteMethod\0\0"
    "slotPresenceReceived\0QXmppPresence\0"
    "presence\0"
};
...
void rpcClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        rpcClient *_t = static_cast<rpcClient *>(_o);
        switch (_id) {
        case 0: _t->slotInvokeRemoteMethod(); break;
        case 1: _t->slotPresenceReceived((*reinterpret_cast< const QXmppPresence(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject rpcClient::staticMetaObject = {
    { &QXmppClient::staticMetaObject, qt_meta_stringdata_rpcClient.data,
      qt_meta_data_rpcClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rpcClient.stringdata))

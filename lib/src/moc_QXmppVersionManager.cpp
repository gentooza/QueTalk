...
struct qt_meta_stringdata_QXmppVersionManager_t {
    QByteArrayData data[4];
    char stringdata[53];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_QXmppVersionManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_QXmppVersionManager_t qt_meta_stringdata_QXmppVersionManager = {
    {
...
QT_MOC_LITERAL(3, 37, 14)
    ...
    "QXmppVersionManager\0versionReceived\0"
    "\0QXmppVersionIq\0"
};
...
void QXmppVersionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QXmppVersionManager::*_t)(const QXmppVersionIq & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppVersionManager::versionReceived)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QXmppVersionManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppVersionManager.data,
      qt_meta_data_QXmppVersionManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QXmppVersionManager.stringdata))

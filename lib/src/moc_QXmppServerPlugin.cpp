...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QXmppServerPlugin_t, stringdata) + ofs \
...
const QMetaObject QXmppServerPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QXmppServerPlugin.data,
      qt_meta_data_QXmppServerPlugin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QXmppServerPlugin.stringdata))
        return static_cast<void*>(const_cast< QXmppServerPlugin*>(this));
    if (!strcmp(_clname, "QXmppServerPluginInterface"))
        return static_cast< QXmppServerPluginInterface*>(const_cast< QXmppServerPlugin*>(this));

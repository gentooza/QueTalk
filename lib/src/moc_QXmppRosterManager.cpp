...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QXmppRosterManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(11, 142, 6),
QT_MOC_LITERAL(12, 149, 18),
QT_MOC_LITERAL(13, 168, 7),
QT_MOC_LITERAL(14, 176, 4),
QT_MOC_LITERAL(15, 181, 13),
QT_MOC_LITERAL(16, 195, 6),
QT_MOC_LITERAL(17, 202, 10),
QT_MOC_LITERAL(18, 213, 10),
QT_MOC_LITERAL(19, 224, 9),
QT_MOC_LITERAL(20, 234, 11),
QT_MOC_LITERAL(21, 246, 12),
QT_MOC_LITERAL(22, 259, 15),
QT_MOC_LITERAL(23, 275, 19),
QT_MOC_LITERAL(24, 295, 13)
    },
    ...
    "_q_presenceReceived\0QXmppPresence\0"
};
...
void QXmppRosterManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppRosterManager::rosterReceived)) {
                *result = 0;
            }
        }
        {
            typedef void (QXmppRosterManager::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppRosterManager::presenceChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (QXmppRosterManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppRosterManager::subscriptionReceived)) {
                *result = 2;
            }
        }
        {
            typedef void (QXmppRosterManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppRosterManager::itemAdded)) {
                *result = 3;
            }
        }
        {
            typedef void (QXmppRosterManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppRosterManager::itemChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (QXmppRosterManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppRosterManager::itemRemoved)) {
                *result = 5;
            }
        }
    }
...
const QMetaObject QXmppRosterManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppRosterManager.data,
      qt_meta_data_QXmppRosterManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QXmppRosterManager.stringdata))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QXmppDiscoveryManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 53, 13)
    ...
    "QXmppDiscoveryIq\0itemsReceived\0"
};
...
void QXmppDiscoveryManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppDiscoveryManager::infoReceived)) {
                *result = 0;
            }
        }
        {
            typedef void (QXmppDiscoveryManager::*_t)(const QXmppDiscoveryIq & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppDiscoveryManager::itemsReceived)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QXmppDiscoveryManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppDiscoveryManager.data,
      qt_meta_data_QXmppDiscoveryManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QXmppDiscoveryManager.stringdata))

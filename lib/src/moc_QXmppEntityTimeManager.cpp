...
struct qt_meta_stringdata_QXmppEntityTimeManager_t {
    QByteArrayData data[4];
    char stringdata[56];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_QXmppEntityTimeManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_QXmppEntityTimeManager_t qt_meta_stringdata_QXmppEntityTimeManager = {
    {
...
QT_MOC_LITERAL(3, 37, 17)
    ...
    "QXmppEntityTimeManager\0timeReceived\0"
    "\0QXmppEntityTimeIq\0"
};
...
void QXmppEntityTimeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QXmppEntityTimeManager::*_t)(const QXmppEntityTimeIq & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QXmppEntityTimeManager::timeReceived)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QXmppEntityTimeManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppEntityTimeManager.data,
      qt_meta_data_QXmppEntityTimeManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QXmppEntityTimeManager.stringdata))

...
QT_MOC_LITERAL(9, 103, 12)
    ...
    "PreferencesDialog\0applied\0\0"
    "rosterIconSizeChanged\0rosterIconReseze\0"
...
void PreferencesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->rosterIconSizeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->rosterIconReseze(); break;
        case 3: _t->readData((*reinterpret_cast< Preferences*(*)>(_a[1]))); break;
        case 4: _t->writeData((*reinterpret_cast< Preferences*(*)>(_a[1]))); break;
        case 5: _t->prefRejected(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreferencesDialog::applied)) {
                *result = 0;
            }
        }
        {
            typedef void (PreferencesDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreferencesDialog::rosterIconSizeChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (PreferencesDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreferencesDialog::rosterIconReseze)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 1
void PreferencesDialog::rosterIconSizeChanged(int _t1)
{

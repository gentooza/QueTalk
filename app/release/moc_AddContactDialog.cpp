...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AddContactDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 57, 5)
    ...
    "AddContactDialog\0enableOkButton\0\0str\0"
    "enableGroupLineEdit\0index\0"
};
...
void AddContactDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->enableOkButton((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->enableGroupLineEdit((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject AddContactDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddContactDialog.data,
      qt_meta_data_AddContactDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddContactDialog.stringdata))
